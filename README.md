...
| **[MirageFS](https://github.com/SSL-ACTX/mirage-fs)** | A high-stealth steganographic filesystem built in Rust. It mounts standard image files (`.png`, `.jpg`, `.webp`) as fully functional encrypted read/write drives, featuring RAID 0 striping and format-specific data morphing strategies. | <img src="https://skillicons.dev/icons?i=rust&theme=dark&perline=1" /> |
