...
| **[Nimue](https://github.com/Iris-Seravelle/nimue)** | A selective Rust virtualization framework (co-authored) utilizing a polymorphic VM architecture and the **Prism** non-linear string protection system for advanced software obfuscation. | <img src="https://skillicons.dev/icons?i=rust,zig&theme=dark&perline=2" /> |
