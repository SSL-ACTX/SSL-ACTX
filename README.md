...
| **[Nimue](https://github.com/SSL-ACTX/nimue)** | A selective Rust code virtualization and obfuscation framework. Transforms sensitive Rust functions into dynamically generated virtual machine instructions executed by a hardened Zig kernel. | <img src="https://skillicons.dev/icons?i=rust,zig&theme=dark&perline=1" /> |
...
| **[Causm](https://github.com/SSL-ACTX/Causm)** | A domain-specific research language addressing concurrent non-determinism through explicit temporal pacing, entropic state decay, and Z3-checked correctness guards. | <img src="https://skillicons.dev/icons?i=rust,ts&theme=dark&perline=2" /> |
